  ...
  _createClass(WordCloud, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rangeColor = _props.rangeColor || ['#fff', '#4ae'],
      ...
      var tmpFill = {}
      function mouseover(d, i, dom) {
        //console.log('x',d, x,y,this)
        tmpFill[i] = dom[i].style.fill
        d3.select(dom[i].component).style('fill', '#FF5722');
      }
      function mouseout(d, i, dom) {
        d3.select(dom[i].component).style("fill", tmpFill[i]);
      }
